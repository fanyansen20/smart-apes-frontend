...
const FilterSideBar = ({
  ...
  const ascendingSpecifications =
    dataSpecificationsFilters &&
    [...dataSpecificationsFilters].sort((a, b) =>
  ...
  useEffect(() => {
    if (dataCategoryLevelOne && !isEmptyObject(dataCategoryLevelOne)) {
  ...
  return (
    <Grid className="containerFilteringSideBar">
      {typeProduct == "products" && (
        <>
          ...
          {!isShopPage &&
            !isEmptyObject(dataCategoryLevelOne) &&
            dataCategoryLevelOne &&
            dataCategoryLevelOne?.map((categoryLevelOne, key) => (
              <List
                key={key}
          ...
          {!isShopPage &&
            ascendingSpecifications &&
            ascendingSpecifications?.map(
