...
export const Header = {
  date: "Effective : 13/02/2023 - Last Update : 13/02/2023",
  title: "SMART APES Privacy Policy",
  subtitle: "DATA PROTECTION NOTICE (SMART APES)",
  description: `This Data Protection Notice (“Notice”) sets out the basis which
...
export const data = [
  ...
  {
    title:
      "Depending on the nature of your interaction with us, some examples of personal data which we may collect from you include your : ",
    list: [
      `Basic personal information: Full name, address, phone number and email address`,
      `Children’s information: Full name, Data of Birth, Gender`,
      `Registration data: newsletter or mailing list requests, and usernames/passwords`,
      `Customer service data: personal data received from partners in respect of employees, or other individuals affiliated with GRIP known to our partners and other feedback from our partners`,
    ],
  },
  {
    title:
  ...
  },
  {
    ...
    list: [
      `performing obligations in the course of or in connection with our services`,
      `processing your purchase of the learning program`,
      `as part of our business operations`,
      `for billing and reporting, such as for invoicing and account management purposes`,
      `for follow-up action regarding any complaints, feedback, queries or requests received via our website or any other communication channels and managing your relationship with us`,
      `sending you marketing information about our products and services, where you have specifically provided such consent`,
  ...
  {
    title: "We may disclose your personal data : ",
    list: [
      ...
      `with your consent, to third party service providers, agents and other organisations we have engaged to perform any of the functions listed in paragraph 7 above for us. Any third parties engaged by us will be contractually bound to keep all personal data confidential.`,
    ],
  },
  {
    title:
  ...
  {
    title:
      "If there is a need to disclose your Personal Data to third parties in line with the purposes mentioned in paragraph 9, we will ensure that they provide sufficient guarantees to us to have implemented the necessary security measures to protect your Personal Data.",
  },
  {
    title:
  ...
  {
    section: "Accuracy of Personal Data",
    title:
  ...
  {
    title:
      "We dispose of or destroy such documents containing your personal data in a secure manner when the retention limit is reached and it is reasonable to assume that the permitted purpose is no longer being served by their retention.",
  },
  {
    title: `For Parents and Children, records will be deleted after 2 years from parent's last login date. It will be disposed of in a secure manner immediately after the said retention period.`,
  },
  {
    section: "Cross-border Transfers of Personal Data",
    title:
  ...
  },
  {
    title: (
      <>
        You may contact our Data Protection Officer via the following contact
        information:
        <Stack sx={{ ml: 3 }}>
          Telephone No: +65 83870804
          <br />
          Email: dpo@grip-principle.com
          <br />
          Address: Katong Shopping Centre, 865 Mountbatten Road, #B1-27, Postal
          437844.
        </Stack>
      </>
    ),
  ...
  {
    section: "Third Party Consent",
    title:
      "In the event you have provided personal data of third parties (e.g. your emergency contact person, family member) to us, we rely on you to have sufficiently obtained the prior consent of such third parties to allow us to collect, use and/or disclose their personal data.",
  },
  {
